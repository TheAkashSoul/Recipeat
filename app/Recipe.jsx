  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false} style={{backgroundColor: '#FFF', position: 'relative'}}>
      ...
      <View style={{padding: 20, alignItems: 'center'}}>
        <TouchableOpacity style={{backgroundColor: '#FB9400', height: 44, width: 180, alignItems: 'center', justifyContent: 'center', borderRadius: 8, display: 'flex', flexDirection: 'row', gap: 4}}>
